...
- **Oğuzhan Esgiyusuf** - *Initial work*

## 📞 İletişim

Proje Linki: [https://github.com/KULLANICI_ADINIZ/wearable-sensor-security-system](https://github.com/KULLANICI_ADINIZ/wearable-sensor-security-system)
...
- Bu uygulama prototip aşamasındadır
- Gerçek tıbbi kullanım için onaylanmamıştır
- Donanım entegrasyonu gereklidir
- Acil durum bildirimleri henüz aktif değildir (geliştirme aşamasında)

## 🔄 Güncellemeler

### v1.0.0 (2025-01-XX)
- ✅ Bluetooth bağlantı yönetimi
- ✅ Kalp atışı takibi ve grafikleri
- ✅ Düşme tespiti algoritması
- ✅ Hareketsizlik alarm sistemi
- ✅ Özelleştirilebilir ayarlar
- ⏳ Bildirim sistemi (geliştiriliyor)